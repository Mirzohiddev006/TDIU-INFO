...
export interface Admission { id: number; program_id: number; year: string; grant_places: number | null; contract_places: number | null; passing_grant: number | null; passing_grant_ru: number | null; passing_contract: number | null; passing_contract_ru: number | null; }
